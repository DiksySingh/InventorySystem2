/*
  ...
  - You are about to drop the column `term` on the `terms_conditions` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Terms_Conditions` DROP COLUMN `term`,
    ADD COLUMN `heading` VARCHAR(191) NULL,
    ADD COLUMN `terms` JSON NULL;
