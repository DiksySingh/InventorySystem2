...
router.post("/add-stage", installationDataController.addStage);
...
router.post("/installation-stage-update", upload.single('file'), installationDataController.bulkUpdateStageFromExcel);
