...
const {generateBhiwaniOverallReport} = require("../helpers/generateBhiwaniDailyInOutReport");
...
router.get("/export-daily-bhiwani-inout-report", generateBhiwaniOverallReport);
router.get("/export-overall-bhiwani-defective-report", generateBhiwaniOverallDefectiveReport);
