...
const {empDashboard, showNewInstallationDataToInstaller, updateStatusOfIncomingItems, showAcceptedInstallationData, newSystemInstallation, pickupItemsByServicePerson, updateFarmerActivitySerialNumbers, getInstallationDataWithImages, updateInstallationFilesByFieldPerson} = require("../controllers/serviceControllers/servicePersonController");
...
router.get("/get-installation-data", userVerification(['serviceperson', 'surveyperson', 'installer']), getInstallationDataWithImages);
router.post("/update-installation-images", userVerification(['serviceperson', 'surveyperson', 'installer']), uploadHandler, updateInstallationFilesByFieldPerson);
// router.post("/update-farmer-acitvity-serial-numbers", userVerification(['serviceperson', 'surveyperson', 'installer']), updateFarmerActivitySerialNumbers)
